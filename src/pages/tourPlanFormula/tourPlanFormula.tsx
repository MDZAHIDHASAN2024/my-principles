...
const tourData = [
  ...
  {
    id: 3,
    rule: ' আপনি যেখানে যাবেন সেখানের রাস্তা এবং জায়গা সম্পর্কে এ ধারণা আছে কি?',
  },
  {
    id: 4,
...
const tipsData = [
  ...
  {
    id: 5,
    tips: 'লোকাল বাসে উঠলে ভাড়া যথা সম্ভব  পরে দেওয়ার চেস্টা করুন । বেশিক্ষন জ্যাম দেখেলে তা কি জন্য লাগছে তা জানার চেষ্টা করুন  এবং যদি সম্ভব হয় রাস্তা টুকু পার হয়ে অন্য গাড়িতে যান । ',
  },
];
